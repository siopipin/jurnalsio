  ...
  return (
    <>
      ...
      <NextSeo
        ...
        canonical={`https://jurnalsio.my.id${router.asPath}`}
        twitter={{
        ...
        openGraph={{
          ...
          site_name: 'JurnalSio',
          description: frontMatter.summary,
          url: `https://jurnalsio.my.id${router.asPath}/`,
          ...
          images: [
            {
              url: `https://jurnalsio.my.id${frontMatter.image}`,
            },
          ],
        }}
      />
      ...
      >
        ...
        >
          ...
          <HStack justifyContent="flex-start" mr="auto" mt={5}>
            <EditIcon />
            <Link
              href={`https://github.com/siopipin/jurnalsio/edit/main/src/data/blog/${frontMatter.slug}.mdx`}
              passHref
            >
              <ChakraLink
